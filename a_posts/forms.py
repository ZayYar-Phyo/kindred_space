    ...
    class Meta:
        ...
        widgets = {
            ...
            forms.Textarea(
                attrs={
                    'rows': 3,
                    'placeholder': 'このアイテムについての思いやりのメッセージを記入してください...',
                    'class': 'font1 text-1xl'
                }),
            'reason':
            forms.Textarea(
                attrs={
                    'rows': 3,
                    'placeholder': 'なぜこれを提供しますか？',
                    'class': 'font1 text-1xl'
                }),
            'tags':
            ...
            forms.Select(
                attrs={
                    'class':
                    'w-full rounded-lg p-3 bg-[rgba(232,240,254,1)] h-[3.3rem]'
                }),
            'latitude':
            forms.HiddenInput(),
            'longitude':
    ...
    class Meta:
        ...
        widgets = {
            ...
            forms.Textarea(
                attrs={
                    'rows': 3,
                    'placeholder': 'このユーザーとの取引体験を教えてください...',
